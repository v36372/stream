...
var _gossip = require("./gossip");

var _gossip2 = _interopRequireDefault(_gossip);
...
//
window.Gossip = _gossip2.default;

});

require.register("web/static/js/gossip.js", function(exports, require, module) {
"use strict";
...
var Gossip = function () {
  ...
  _createClass(Gossip, null, [{
    ...
    value: function init() {
      ...
      _socket2.default.onOpen(function (ev) {
        return console.log("OPEN", ev);
      });
      _socket2.default.onError(function (ev) {
        return console.log("ERROR", ev);
      });
      _socket2.default.onClose(function (e) {
        return console.log("CLOSE", e);
      });

      var chan = _socket2.default.channel("rooms:lobby", { user: $username.val() });
